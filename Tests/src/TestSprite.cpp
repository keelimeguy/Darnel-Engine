...
namespace test {
    ...
    TestSprite::TestSprite(int i) {
        ...
        m_star1 = darnel::Sprite::Create(270.0f, 190.0f, 100.0f, 100.0f, m_texture);
        m_star2 = darnel::Sprite::Create(25.0f, 25.0f, 50.0f, 50.0f, m_texture);
        m_color1 = darnel::Sprite::Create(50.0f, 50.0f, 50.0f, 50.0f, darnel::Texture::Create(255, 255, 0, 100));
        m_color2 = darnel::Sprite::Create(565.0f, 25.0f, 50.0f, 50.0f, darnel::Texture::Create(255, 0, 255));
