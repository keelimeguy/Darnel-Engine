...
SampleDX12::SampleDX12(const std::wstring& name, int width, int height, bool vSync)
...
SampleDX12::~SampleDX12()
{
    _aligned_free(m_pAlignedCameraData);
}

bool SampleDX12::LoadContent()
{
    ...
    // Load some textures
    commandList->LoadTextureFromFile(m_DefaultTexture, L"resources/textures/DefaultWhite.bmp");
    commandList->LoadTextureFromFile(m_DirectXTexture, L"resources/textures/Directx9.png");
    commandList->LoadTextureFromFile(m_EarthTexture, L"resources/textures/earth.dds");
    commandList->LoadTextureFromFile(m_MonaLisaTexture, L"resources/textures/Mona_Lisa.jpg");
    commandList->LoadTextureFromFile(m_GraceCathedralTexture, L"resources/textures/grace-new.hdr");
...
void SampleDX12::OnResize(ResizeEventArgs& e)
{
    super::OnResize(e);
...
void SampleDX12::UnloadContent()
{
}

void SampleDX12::OnUpdate(UpdateEventArgs& e)
{
...
void SampleDX12::OnRender(RenderEventArgs& e)
{
    super::OnRender(e);
...
void SampleDX12::OnKeyPressed(KeyEventArgs& e)
{
...
void SampleDX12::OnKeyReleased(KeyEventArgs& e)
{
...
void SampleDX12::OnMouseMoved(MouseMotionEventArgs& e)
{
...
void SampleDX12::OnMouseWheel(MouseWheelEventArgs& e)
{
    if (!ImGui::GetIO().WantCaptureMouse)
    {
